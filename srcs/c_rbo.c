...
/*   Updated: 2018/09/19 00:46:59 by ntoniolo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "scop.h"

void			rbo_render(t_rbo *rbo,
							t_shader *shader,
							t_model *model,
							const float time)
{
	...
	glDrawElements(GL_TRIANGLES, m_mesh->mesh[0]->nb_indices,
			GL_UNSIGNED_INT, 0);
	glBindVertexArray(0);
	glUseProgram(0);
