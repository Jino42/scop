...
#    Updated: 2018/09/19 21:32:58 by ntoniolo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC = -I includes/ -I libft/includes -I vector/includes/ -I matrix/includes/ -I glfw-3.2.1/include/GLFW/ -g3 -I ~/.brew/include/ -I ./cJSON/ -I glfw-3.2.1/ -I nuklear/src/
